  ...
  const projects = [
    {
      ...
      tags: ["Django REST", "React", "PostgreSQL", "Tailwind", "Docker"],
      ...
      <main className="max-w-6xl mx-auto px-4 pt-32 pb-20">
        ...
        >
          ...
          <div className="flex justify-center gap-4 pt-4">
            ...
            <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="flex items-center gap-2 px-6 py-3 bg-primary-600 text-white rounded-lg font-medium hover:bg-primary-700 transition-colors">
              <Linkedin size={20} /> LinkedIn
            </a>
          </div>
        </motion.div>

        {/* Tech Stack Preview (Visualmente simple) */}
        <div className="mt-20 py-10 border-y border-gray-200 dark:border-gray-800">
            ...
            <div className="flex flex-wrap justify-center gap-8 md:gap-16 opacity-70 grayscale hover:grayscale-0 transition-all duration-500">
                {/* Aquí podrías poner iconos reales, uso texto por ahora */}
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {projects.map((project, index) => (
              ...
              >
                ...
                <a href="#" className="inline-flex items-center text-primary-600 dark:text-primary-400 font-medium hover:underline text-sm">
